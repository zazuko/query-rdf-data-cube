...
export class Component extends BaseExpr {
  ...
  /**
   * Classes [[Dimension]], [[Attribute]] and [[Measure]] inherit from this [[Component]] class.
   * @param args Arguments describing a component.
   * @param args.iri - The IRI of the Component.
   * @param args.labels - Labels for the component. See [[Label]].
   */
  constructor(args: { labels?: Label[], iri: string | Term}) {
    super();
